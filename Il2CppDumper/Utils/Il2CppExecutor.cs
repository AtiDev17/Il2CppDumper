...
namespace Il2CppDumper
{
    public class Il2CppExecutor
    {
        ...
        public Il2CppGenericParameter GetGenericParameteFromIl2CppType(Il2CppType il2CppType)
        {
            if (il2Cpp.Version >= 27 && il2Cpp.IsDumped)
            {
                var offset = il2CppType.data.genericParameterHandle - metadata.ImageBase - (metadata.Version < 38 ? metadata.header.genericParametersOffset : metadata.header.genericParameters.offset);
